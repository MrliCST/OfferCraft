 ...
 *
 * <p>这里管的是"以什么身份打开网页"，跟 {@code screenshot.*}（截图怎么截）、{@code web-text.*}
 * （正文留多少字）都是两件事，所以分开配置：本类决定<b>能不能</b>看到登录后的内容，
 * 那两个决定看到的画面/文字<b>怎么处置</b>。
 *
...
public record BrowserSessionProperties(
     ...
     */
    public static BrowserSessionProperties of(String cdpEndpoint) {
        return new BrowserSessionProperties(cdpEndpoint, List.of());
    }
